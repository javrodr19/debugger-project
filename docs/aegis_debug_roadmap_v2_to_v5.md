...
**Date:** 2026-08-06
**Status:** V1, V2, and V3 (V3.1 Custom Rules, V3.2 Rule Packs, V3.3 Fix-Preview UX, V3.4 External SDK) + Plugin Actions (Batches 1–3) shipped in `v.3.0.0`. V4 (Debug-Time UX) is current active target.
