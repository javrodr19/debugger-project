    ...
    fun generateHTMLReport(graph: ProjectGraph): String {
        ...
        val htmlTemplate = """
            ...
            <head>
                ...
                <title>GhostDebugger Report - ${graph.metadata.projectName}</title>
                <style>
                    body {
            ...
            <body>
                <div class="container">
                    ...
                    <footer>
                        <p>Generated by GhostDebugger IntelliJ Plugin • ${graph.metadata.projectName}</p>
                    </footer>
                </div>
            </body>
            </html>
